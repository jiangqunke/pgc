...
import static com.bestv.pgc.preloader.videocache.ProxyCacheUtils.DEFAULT_BUFFER_SIZE;

import android.text.TextUtils;


import com.bestv.pgc.preloader.videocache.file.FileCache;
...
//    private final HttpUrlSource source;
    ...
    public HttpProxyCache(UrlSource source, FileCache cache) {
        super(source, cache);
        this.cache = cache;
        this.source = source;
    }
    ...
    //    HttpUrlSource newSourceNoCache = new HttpUrlSource(this.source);
        UrlSource newSourceNoCache = null;
        if (this.source instanceof OKhttpUrlSource)
            newSourceNoCache = new OKhttpUrlSource((OKhttpUrlSource) this.source);
        else
            newSourceNoCache = new HttpUrlSource((HttpUrlSource) this.source);
        try {
