...
public class StorageManager {
    ...
    private void addCache(String key, CacheFileInfo cacheFileInfo) {
        ...
        LogUtils.i(TAG, "addCache: mCurrentSize = " + mCurrentSize +
                " cacheFileInfo path = " + cacheFileInfo.mFilePath +
                " cacheFileInfo size = " + cacheFileInfo.mSize);
    }
    ...
    private void removeCache(String key) {
        ...
        if (cacheFileInfo != null) {
            ...
            LogUtils.i(TAG, "removeCache: mCurrentSize = " + mCurrentSize +
                    " cacheFileInfo path = " + cacheFileInfo.mFilePath +
                    " cacheFileInfo size = " + cacheFileInfo.mSize);
        }
    }
