...
public class OkHttpControl {
    ...
    public long getContentLength() {
        ...
        if (mResponse.code() == 200 || mResponse.code() == 206) {
            ...
            if (mResponse.code() == 206) {
                LogUtils.w(TAG, "getContentLength code 206, url: " + mUrl);
            }
            LogUtils.d(TAG, "getContentLength: contentLength: " + contentLength + " url: " + mUrl);
    ...
    public long parseContentLengthFromContentRange() {
        ...
        if (mResponse.code() == 200 || mResponse.code() ==206) {
            ...
            LogUtils.d(TAG, "parseContentLengthFromContentRange: contentRange: " + contentRange + " url: " + mUrl);
