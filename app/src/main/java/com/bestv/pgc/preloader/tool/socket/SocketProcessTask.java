package com.bestv.pgc.preloader.tool.socket;
...
import com.bestv.pgc.preloader.tool.socket.response.BaseResponse;
import com.bestv.pgc.preloader.tool.socket.response.M3U8Response;
import com.bestv.pgc.preloader.tool.socket.response.M3U8SegResponse;
import com.bestv.pgc.preloader.tool.socket.response.Mp4Response;
        ...
        try {
            ...
            while(!mSocket.isClosed()) {
                ...
                if (url.contains(ProxyCacheUtils.VIDEO_PROXY_SPLIT_STR)) {
                    ...
                    String currentmMd5 = ProxyCacheUtils.computeMD5(videoUrl);
                    String playingUrlMd5 = VideoProxyCacheManager.getInstance().getPlayingUrlMd5();
                    LogUtils.d(TAG, "currentmMd5 = " + currentmMd5 + " playingUrlMd5 = " + playingUrlMd5);
                    response.sendResponse(mSocket, outputStream);
                    LogUtils.d(TAG, "sendResponse complete, url = " + url);
