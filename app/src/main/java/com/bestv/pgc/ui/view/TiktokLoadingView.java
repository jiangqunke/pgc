...
public class TiktokLoadingView extends View {
    ...
    public TiktokLoadingView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public TiktokLoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
