...
final class AudioFocusHelper implements AudioManager.OnAudioFocusChangeListener {
        ...
        private WeakReference<ExoVideoView> mWeakVideoView;
        ...
        AudioFocusHelper(@NonNull ExoVideoView videoView) {
        ...
        public void onAudioFocusChange(int focusChange) {
            ...
            ExoVideoView videoView = mWeakVideoView.get();
...
//                        videoView.pause();
                ...
                case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK://此时需降低音量
                    if (videoView.isPlaying() && !videoView.getMute()) {
                        videoView.pause();
                    }
                    break;
            }
